...
public class ProjectServiceImpl implements ProjectService {
    ...
    public ProjectServiceImpl(ProjectRepository projectRepository, UserRepository userRepository, UserService userService, TaskService taskService, MapperUtil mapperUtil) {
