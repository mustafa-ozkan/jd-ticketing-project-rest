...
public class PerformanceAspect {
    ...
    public Object anyExecutionTimeOperationAdvice(ProceedingJoinPoint proceedingJoinPoint){
        ...
        log.info("Time taken to execute : {} ms (Method : {} - Parameters : {}", (afterTime-beforeTime), proceedingJoinPoint.getSignature().toShortString(),proceedingJoinPoint.getSignature());
